...
export default function SerchBar({pagina, set}) {
    ...
    function handleClick(e){
            ...
            if(app.classList.contains('filters-nav__inside'))app.classList.remove('filters-nav__inside');
    ...
    return (
        <nav className='contenedor-SearchBar'>
            ...
            <div className='searchBar-logo'>
                <img src={icon} alt="" className='searchBar_icon' onClick={e => handleClickAllDogs(e)}/>
                <Link to='/create'>
                    <button className='searchBar_create'><p className='searchBar_text'>CREATE YOUR DOG</p></button>
                </Link>
            </div>
            ...
            <div className='searchbar-create-icon'>
                ...
                <img src={menu}
                className="searchBar-img" id='searchBar-img'
                onClick={handleClick}
                alt="Not do found"></img>
            </div>
            </div>

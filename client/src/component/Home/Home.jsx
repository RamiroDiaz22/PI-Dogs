...
export default function Home() {
    ...
    return (
        <div>
            ...
            {
                currentDogs?.map(d => {
                    return (<Card key={d.id} id={d.id}
                        name={d.name} image={d.image? d.image: DogIcon}
                        temperament={
                            d.temperament
                        ...
                        weight={d.weight? d.weight[0] : d.weight_min}/>) // le paso siempre el peso minimo
                })
            }
            </div>
            {
